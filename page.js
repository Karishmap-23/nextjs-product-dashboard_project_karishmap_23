    ...
    <div className={styles.dashboardContainer}>
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.formContainer}>
          ...
          <form>
            <input type="text" placeholder="Product Name" className={styles.inputBox} />
            <input type="number" placeholder="Price" className={styles.inputBox} />
            <input type="number" placeholder="Stock Quantity" className={styles.inputBox} />
